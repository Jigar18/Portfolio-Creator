...
export default function Home() {
  ...
  const footerInView = useInView(footerRef as React.RefObject<HTMLElement>, { once: false })
  ...
  return (
    <div ref={topRef} className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900">
      <main className="mx-auto w-full max-w-6xl space-y-10 text-slate-200 py-12 px-4 sm:px-6 sm:py-16 lg:py-20">
        ...
        >
          <div className="container mx-auto flex md:flex-row justify-center items-center gap-4">
            <p className="text-slate-400 text-sm">© {new Date().getFullYear()} Jigar Kumar. All rights reserved.</p>
          </div>
        </motion.footer>
      </main>

      {/* Certificate Modal at the root level */}
      <CertificateModal
      ...
      {/* Project Modal at the root level */}
      <ProjectModal
